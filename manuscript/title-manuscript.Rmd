...
```{r fig-5, fig.cap = "Fig. 5: We found no statistically signifcant relationship between SJR and HDI of nations mentioned in article titles", echo = FALSE, message = FALSE, warning = FALSE}
