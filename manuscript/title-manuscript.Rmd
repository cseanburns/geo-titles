...
```{r fig-1, fig.cap = "Fig. 1: There is a weak relationship between citations and position of place name in title.", echo = FALSE}
...
*p* = `r round(places2SJR$p.value, 3)`).

```{r fig-2, fig.cap = "Fig. 2: There is a statistically weak relationship between the frequency of articles with place names in titles in a journal and the journal's impact score", echo = FALSE, message = FALSE}
...
```{r fig-3, fig.cap = "Fig. 3: The relationship between average rocation of nation named in article title and HDI. Only nations appearing in at least ten articles are displayed.", echo = FALSE}
...
*p* = `r round(HDI2journals$p.value, 3)`)
...
```{r fig-4, fig.cap = "Fig. 4: We found no statistically signifcant relationship between SJR and HDI of nations mentioned in article titles", echo = FALSE, message = FALSE, warning = FALSE}
